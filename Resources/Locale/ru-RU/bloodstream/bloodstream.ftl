...
bloodstream-component-slight-bleeding = [color=#893843]{CAPITALIZE(SUBJECT($target))} {CONJUGATE-BE($target)} слегка истекает кровью.[/color]

bloodstream-component-massive-bleeding = [color=#420000]{CAPITALIZE(SUBJECT($target))} {CONJUGATE-BE($target)} сильно истекает кровью.[/color]
