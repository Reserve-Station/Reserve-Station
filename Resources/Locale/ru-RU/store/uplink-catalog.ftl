...
uplink-neuro-stabilization-implanter-name = Имплантер нейро-стабилизации
uplink-neuro-stabilization-implanter-desc = Имплант, полностью блокирующий урон по выносливости, но наносящий электротравму при каждом срабатывании. Для настоящих берсерков.
