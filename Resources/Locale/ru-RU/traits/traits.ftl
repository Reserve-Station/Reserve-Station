...
trait-monochromacy-name = Монохромность

trait-monochromacy-desc = Вы полностью дальтоник, все, что вы воспринимаете, варьируется от черного до белого.

trait-newyork-name = Нью-йоркский акцент

trait-newyork-desc = Вы говорите с сильным нью-йоркским акцентом. Я, черт возьми, иду сюда!

trait-british-name = Британский акцент

trait-british-desc = Ты говоришь правильно, в отличие от этих чертовых янки.
