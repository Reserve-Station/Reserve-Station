...
cmd-setadminooc-desc = Устанавливает цвет ваших сообщений в OOC. Цвет должен быть в шестнадцатеричном формате, например: setadminooc #c43b23.

cmd-setadminooc-help = Использование: setadminooc <цвет>
