...
permissions-eui-menu-add-admin-button = Добавить фрика
...
permissions-eui-menu-admins-tab-title = Фрики
permissions-eui-menu-admin-ranks-tab-title = Админ ранги
permissions-eui-edit-admin-window-edit-admin-label = Редактировать фрика { $admin }
