...
ent-ClothingOuterWinterSec = зимняя куртка службы безопасности
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterSecArmored = зимняя бронекуртка службы безопасности
...
ent-ClothingOuterWinterSeniourSecArmored = ветеранская зимняя бронекуртка службы безопасности
    .desc = Прочное, утилитарное зимнее пальто, предназначенное для защиты сотрудников службы безопасности от любых угроз и переохлаждения.
