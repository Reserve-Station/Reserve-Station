...
abductors-ghost-role-desc = Похищайте людей и вставляйте им экспериментальные органы сомнительного происхождения.
...
objective-condition-abduct-description = (используйте Gizmo на лежачей цели, затем используйте Gizmo на консоли похитителя и выберите действие «Привлечь»), затем замените их сердце на одну из желез, поместите их в экспериментатор и нажмите «Завершить эксперимент».
