...
cmd-delayroundend-desc = Останавливает таймер, который завершает раунд, когда аварийный шаттл стыкуется к ЦК.
...
cmd-launchemergencyshuttle-desc = Если возможно, запускает аварийный шаттл.
