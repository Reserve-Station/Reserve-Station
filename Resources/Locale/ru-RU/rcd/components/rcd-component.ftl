...
rcd-component-deconstruct-target-no-access = У вас нет доступа, чтобы разобрать это!

rcd-component-deconstruct-target-is-bolted = Болты механизма предотвращают демонтаж!
