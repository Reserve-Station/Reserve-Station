...
job-description-command-maid = Очистите мостик, командные помещения и все остальное, что вам прикажет командование.

job-description-security-clown = Выполняй работу службы безопасности, но не забывай делать это со своим клоуном.
