...
mood-effect-HungerOverfed = { GENDER($entity) ->
    ...
    [epicene] Я так много поели, что чувствую, будто вот-вот лопну!
...
mood-effect-ThirstOverHydrated = { GENDER($entity) ->
    ...
    [epicene] Я напились воды вдоволь.
...
mood-effect-MobSlipped = { GENDER($entity) ->
    ...
    [epicene] Я поскользнулись! В следующий раз буду осторожнее.
   *[neuter] Я поскользнулось! В следующий раз буду осторожнее.
}

mood-effect-MobVomit = Моя еда ужасна на вкус, когда выходит обратно.
...
mood-effect-NicotineBenefit =
    { GENDER($entity) ->
        ...
        [epicene] Я чувствую, будто всю жизнь стояли, а теперь сели.
...
mood-effect-NicotineWithdrawal =
    { GENDER($entity) ->
        ...
        [epicene] Прямо сейчас я бы с удовольствием покурили.
...
mood-effect-EthanolBenefit =
    { GENDER($entity) ->
        ...
        [epicene] Я так расслабились от выпивки.
...
mood-effect-DrankBlood =
    { GENDER($entity) ->
        ...
        [epicene] Я только что выпили солёную, тёплую кровь. Это отвратительно!
...
mood-effect-DrankInsectBlood =
    { GENDER($entity) ->
        ...
        [epicene] Я только что выпили слизкую насекомую жижу. Это отвратительно!
...
mood-effect-DrankVomit =
    { GENDER($entity) ->
        ...
        [epicene] Зачем я только что выпили эту рвоту? Она на вкус как рвота!
...
mood-effect-OilyEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то, приготовленное в масле.
...
mood-effect-SaltyEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то солёное, было очень вкусно!
...
mood-effect-MintyEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то мятное, это было прохладно и освежающе.
...
mood-effect-PepperEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то перчёное, было очень вкусно!
...
mood-effect-ChocolateEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то с шоколадом, это было невероятно вкусно!
...
mood-effect-ButterEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели масляное лакомство и могли бы есть это весь день.
...
mood-effect-DeepFriedEffect =
    { GENDER($entity) ->
        ...
        [epicene] Я съели что-то во фритюре! Это было самое вкусное, что я когда-либо ели!
