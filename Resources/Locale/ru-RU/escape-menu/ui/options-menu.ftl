...
ui-options-highlight-volume = Громкость звука подсветки в чате:
...
ui-options-function-toggle-knockdown = Ползти/встать
...
ui-options-function-smart-equip-back = Умная экипировка в слот спины
...
ui-options-function-loadout-shift1 = Набор хотбара Shift+1
ui-options-function-loadout-shift2 = Набор хотбара Shift+2
ui-options-function-loadout-shift3 = Набор хотбара Shift+3
ui-options-function-loadout-shift4 = Набор хотбара Shift+4
ui-options-function-loadout-shift5 = Набор хотбара Shift+5
ui-options-function-loadout-shift6 = Набор хотбара Shift+6
ui-options-function-loadout-shift7 = Набор хотбара Shift+7
ui-options-function-loadout-shift8 = Набор хотбара Shift+8
ui-options-function-loadout-shift9 = Набор хотбара Shift+9
ui-options-function-loadout-shift0 = Набор хотбара Shift+0
...
ui-options-function-text-release-focus = Снять фокус с поля ввода
...
ui-options-highlight-sound = Звук при подсветке в чате
...
ui-options-admin-player-panel = Список игроков в админ-меню

ui-options-admin-player-tab-symbol-setting = Символы антагонистов в столбце персонажа
...
ui-options-admin-player-tab-symbol-setting-specific = Особый символ антагониста
...
ui-options-toggle-translit-en-to-ru = (Чат) Транслитерировать латинский ввод в кириллицу
ui-options-toggle-translit-ru-to-en = (Чат) Транслитерировать кириллицу в чате в латиницу
