...
knowledge-path-rust-s8-rust-charge-name = Ржавый заряд
knowledge-path-rust-s8-rust-charge-desc = Холмы сверкали, когда я приблизился к ним, мои мысли начали блуждать. Я быстро восстановил свою решимость и двинулся вперед, этот последний этап будет самым коварным.
