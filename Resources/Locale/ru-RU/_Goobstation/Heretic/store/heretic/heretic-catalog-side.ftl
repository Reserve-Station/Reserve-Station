...
knowledge-path-side-s6-ice-spear-desc = Артефакты, связанные с Зимним рассветом, излучают неестественную тишину. Время вокруг них замедляется. Пожары задыхаются. Мысли становятся хрупкими. Близость порождает галлюцинации бесконечных белых полей, неба без солнца и голоса, говорящего только сквозь треск льда.
