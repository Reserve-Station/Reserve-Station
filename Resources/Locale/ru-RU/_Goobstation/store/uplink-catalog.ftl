...
uplink-adv-mimery-name = Руководство по серии продвинутой техники мима.

uplink-adv-mimery-desc = Классическая серия из двух частей о том, как еще больше отточить свои навыки пантомимы. Изучив серию, пользователь сможет создавать невидимые стены 3x1 и стрелять пулями из пальцев.

uplink-estoc-name = Эсток

uplink-estoc-desc = Стрелковая винтовка, предназначенная для стрельбы очередями, оснащенная дорогой тритиевой оптикой. Стреляет патронами .20 калибра.

uplink-estoc-ammo-name = Винтовочный магазин (винтовка .30)

uplink-estoc-ammo-desc = Магазин винтовки на 30 патронов. Совместим с Эстоком.

uplink-m90-ammo-name = Винтовочный магазин (винтовка .20)

uplink-m90-ammo-desc = Магазин винтовки на 25 патронов. Совместим с М-90 и Лектером.

uplink-ExplosivePayloadBlueprint-name = Чертеж взрывоопасной техники

uplink-ExplosivePayloadBlueprint-desc = Чертеж, который позволит на одном автолате печатать взрывчатое вещество — незаконное и опасное устройство, которое можно использовать в гранатах.

uplink-carpcaller-name = Призыватель космического карпа

uplink-carpcaller-desc = Устройство, использующее психологию карпа, которое, будучи закреплено на якоре, включено и находится на открытом пространстве, будет привлекать диких космических карпов. Имейте в виду, что вы им не друг.

uplink-bloodred-cassette-name = Кроваво-красный кассетный проигрыватель

uplink-bloodred-cassette-desc = Портативный музыкальный плеер, предоставленный самыми эгоистичными модельерами Cybersun!
