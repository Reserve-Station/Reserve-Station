...
powersink-imminent-explosion-announcement = Сканирование системы обнаружило, что несанкционированное энергопотребляющее устройство работает нестабильно. Персоналу рекомендуется обнаружить и отключить это устройство непосредственно до повреждения станции.
